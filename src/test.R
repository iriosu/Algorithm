...
# Reading files -----------------------------------------------------------
#carreras_requisitos
car_req_13 = read.csv("Datos/PAUC 2013/Output/postulaciones_procesadas_reg_student_secuencial_2013.csv", sep = ";", header=TRUE)
car_req_14 = read.csv("Datos/PAUC 2014/Output/postulaciones_procesadas_reg_student_secuencial_2014.csv", sep = ";", header=TRUE)
car_req_15 = read.csv("Datos/PAUC 2015/Output/postulaciones_procesadas_reg_student_secuencial_2015.csv", sep = ";", header=TRUE)
car_req_16 = read.csv("Datos/PAUC 2016/Output/postulaciones_procesadas_reg_student_secuencial_2016.csv", sep = ";", header=TRUE)
